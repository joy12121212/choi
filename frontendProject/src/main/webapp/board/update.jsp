...
<body>
	...
	<div class="container">
		...
		<div class="row justify-content-center gx-3 m-3">
			<div class="col-1 "> <input onclick="onUpdate()" class="form-control btn btn-dark" type="button" value="등록"></div>
			<div class="col-1"> <input class="form-control btn btn-warning" type="button" value="다시쓰기"></div>
			<div class="col-1 "> <input class="form-control btn btn-warning" type="button" value="목록보기"></div>
	...
	<script src="/frontendProject/js/update.js" type="text/javascript"></script>
