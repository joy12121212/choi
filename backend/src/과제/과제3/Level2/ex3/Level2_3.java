...
public class Level2_3 {
	...
	public static void main(String[] args) {
		...
		int sum = kor + eng + mat;
		double ave = sum / 3;
		String x3 = sum % 3 == 0 ? "true" : "false";
		String x8 = sum % 8 == 0 ? "true" : "false";
		String odd_even = sum % 2 == 0 ? "짝수" : "홀수";
		String result = sum >= 65? "합격":"불합격";
		
		System.out.println(kor+"\t"+eng+"\t"+mat+"\t"+sum+"\t"+ave+"\t"+x3+"\t"+x8+"\t"+odd_even+"\t"+result+"\t");
