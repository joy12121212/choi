...
public class Level1_3 {
	...
	public static void main(String[] args) {
		...
		System.out.println("output boolean : " + a3);
		System.out.println("output byte : " + b3);		
		System.out.println("output byte : " + c3);		
		System.out.println("output short : " + d3);
		System.out.println("output int : " + e3);		
		System.out.println("output long : " + f3);
		System.out.println("output float : " + g3);		
		System.out.println("output double : " + h3);
