...
public class Level1_6 {
	...
	public static void main(String[] args) {
		...
		/* 문제풀이 위치 */
		byte b6 = (byte) value1;
		short s6 = (short) value2;
		int i6 = (int) value3;
		long l6 = (long) value4;
		float f6 = (float) value5;
		System.out.println("byte <- short : " + b6 );
		System.out.println("short <- int : " + s6 );
		System.out.println("int <- long : " + i6 );
		System.out.println("long <- flaot : " + l6 );
		System.out.println("float <- double : " + f6 );
