...
public class Level1_8 {
	...
	public static void main(String[] args) {
		...
		System.out.println("1\t"+str1+"\t"+str11);
		...
		System.out.println(header);
		System.out.println("1\t"+str1+"\t"+str11);
		System.out.println("2\t"+str2+"\t"+str22);
		System.out.println(footer);
		...
		System.out.println("1\t"+str1+"\t"+str11);
		System.out.println("2\t"+str2+"\t"+str22);
		System.out.println("3\t"+str3+"\t"+str33);
		System.out.println(footer);
		...
		System.out.println("2\t"+str2+"\t"+str22);
		System.out.println("3\t"+str3+"\t"+str33);
		System.out.println("4\t"+str4+"\t"+str44);
		System.out.println(footer);
		
		System.out.print("[5]작성자 : ");
		String str5 = scanner.nextLine();		
		System.out.print("[5]방문록 : ");		
		String str55 = scanner.nextLine();
		...
		System.out.println("3\t"+str3+"\t"+str33);
		System.out.println("4\t"+str4+"\t"+str44);
		System.out.println("5\t"+str5+"\t"+str55);
		System.out.println(footer);
