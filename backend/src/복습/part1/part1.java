	  ...
	  while (true) {
		...
		if (sc == 1) {
			if (콜라재고 == 0) {
				...
				콜라재고--; 콜라바구니++; System.out.println("콜라\t" +콜라바구니+"\t"+(콜라가격*콜라바구니)+"\n");
				총금액 += 콜라가격;
			}
		}
			...
			if (환타재고 == 0) {
				...
				환타재고--; 환타바구니++; System.out.println("환타\t" +환타바구니+"\t"+(환타가격*환타바구니)+"\n");
				총금액 += 환타가격;
			}
		}
			...
			if (사이다재고 == 0) {
				...
				사이다재고--; 사이다바구니++; System.out.println("사이다\t" +사이다바구니+"\t"+(사이다가격*사이다바구니)+"\n");
				총금액 += 사이다가격;
			}
		}
		...
		if (sc == 4) {
			...
			System.out.println("결제하실 금액 : " + 총금액);
			System.out.println("금액을 입력해 주세요");
			int 결제할금액 = scanner.nextInt();
